...
===========================
Future adapter specification for Anthropic Claude Code agent harnesses.
"""
...
class ClaudeCodeAdapter(HarnessAdapter):
    """Adapter for future Anthropic Claude Code agent harnesses."""
    ...
    async def analyze_visual(self, image_path: Path, prompt: str = "") -> VisualAnalysis:
        return VisualAnalysis(
            ...
            raw_summary="Claude Code visual analysis specification.",
        )
